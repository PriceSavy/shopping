    ...
    Future validateData(String username, String email, String phonenumber,String password,String confirm)async{
      ...
      if(password==confirm){
        ...
        try{
          ...
          var response = await Dio().post('http://192.168.5.5:8000/api/user/', data: data);
                   ...
                   Container(
                     ...
                     child: Row(
                      ...
                      Container(
                        child: Column(
                          children: [
                            Text('To get registered, please enter your details below.',style: TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),
                          ...
                          child: Container(
                            child: Column(
                                        ...
                                        child:   TextFormField(
                                          ...
                                          validator: (pass){
                                            if(pass!.isEmpty){
                                              ...
                                              errorText = 'Password should be atleast 4';
                                            }else return null;
                                            return errorText;
                                          },
                                          decoration: InputDecoration(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: (value){
                                            if(value!.isEmpty){
                                              ...
                                              errorText2 = 'Password should be atleast 4';
                                            }else return null;
                                            return errorText2;
                                          },
                                          decoration: InputDecoration(
                              ...
                              if(_formKey.currentState!.validate()){
                                validateData(usernameController.text, emailController.text, phonenumberController.text, passwordController.text,confirmPassController.text);
